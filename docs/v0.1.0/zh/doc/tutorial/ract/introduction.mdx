...
如果您只是想要快速入门并进行使用你可以只看[基础使用](zh/doc/tutorial/ract/common_commands)和对应的框架使用

当你只将Ract使用在`GenUI`项目，你只需要学习：
- [基础使用](/zh/doc/tutorial/ract/common_commands)
- [Ract for GenUI](/zh/doc/tutorial/ract/gen_ui)
