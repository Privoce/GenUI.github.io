...
> [!TIP]
>
> 更多Ract详细命令请参照: [Ract](zh/tools/ract/introduction)
...
Ract会提示您相关的工具链的缺失，如果您的工具链不完整，可以直接使用`ract install`命令进行相应的安装
