...
:::tip
`Ract` is the first step to start GenUI. Please choose the latest version to download. For Ract usage, please refer to the tutorial: [Ract](/zh/doc/tutorial/ract)
:::

## VSCode plugin <Badge text="Comming Soon" type="warning" />

GenUI's VSCode plugin, including: code coloring, syntax support, icons, AIGC, version updates, and other functions.

We are actively building...

## Remote service <Badge text="Comming Soon" type="warning" />

Remote service, including remote packaging, remote project building, AIGC, online code, plugin warehouse, etc. (similar to V0)
